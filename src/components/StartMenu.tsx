...
const StartMenu: React.FC<StartMenuProps> = ({
  ...
  const menuItems = [
    {
      ...
      items: [
        ...
        { icon: '🌸', label: 'Yuzy Socials', action: () => handleSocialsClick('yuzy-socials') },
        { icon: '🌟', label: 'Assad Socials', action: () => handleSocialsClick('assad-socials') },
      ]
    },
    {
      id: 'about',
  ...
  const showLoveNotification = () => {
    ...
    notification.innerHTML = `
      <div class="flex items-center space-x-2">
        ...
        <span class="font-medium text-gray-800">Yuzy and Assad forever! {'>'} w {'<'}</span>
  ...
  const showAboutNotification = () => {
    ...
    notification.innerHTML = `
      <div class="flex items-center space-x-2">
        <span class="text-2xl">🌸</span>
        <span class="font-medium text-gray-800">MatchaOS - The cutest OS ever! uwu</span>
        <span class="text-xl">💖</span>
      </div>
    `;
    document.body.appendChild(notification);
